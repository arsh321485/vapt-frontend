<template>
    ...
    <section class="vulnerability-explorer">
        ...
        <div class="col-4">
            <div class="card text-start shadow" style="border-radius: 12px;">
                <div class="card-body">
                    ...
                    <h1 style="font-size: 55px;">$320<span class="mt-auto fs-5" style="color: rgba(0, 0, 0, 1);font-size: 16px;">per month</span></h1>
        ...
        <div class="row my-5">
            <p class="text-center mt-5" style="color: rgba(0, 0, 0, 0.87);font-weight: 500;font-size: 15px;">Trusted by 30+ companies</p>
