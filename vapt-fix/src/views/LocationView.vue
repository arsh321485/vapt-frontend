              ...
              <div class="row">
                <div class="col-lg-9 location-card py-4 px-4">
                    ...
                    <div class="row">
                      ...
                      <div class="col-4">
                        <button class="btn py-2 px-4 add-location-btn text-light" type="submit"><i class="bi bi-plus me-2"></i>Add location </button>
                      </div>
                    </div>
                </div>
              </div>
                ...
                <div class="col-lg-12 add-users py-4 px-4">
                   <div class="row">
                      ...
                      <input
                        ...
                        style="display: none"
                      />
                      <button class="btn upload-btn" @click="triggerFileInput"><i class="bi bi-upload me-2"></i>  Upload CSV</button>
                    </div>
                    </div>
                    <form>
      <div class="row g-3">
          ...
          />
                    ...
                    <div class="row">
                      <div class="col-2 mt-4">
                          <button class="btn py-2 px-4 add-location-btn text-light" type="submit"><i class="bi bi-plus me-2"></i>Add user </button>
                      </div>
                    </div>
                    <div class="row">
